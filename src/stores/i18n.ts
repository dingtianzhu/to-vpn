...
const translations = {
  en: {
    ...
    routing: {
      ...
      globalMode: "Global",
      directMode: "Direct",
      ruleDesc: "Bypass China",
      globalDesc: "All proxy",
      directDesc: "All direct",
      switching: "Switching...",
      hint: "Changing route mode while connected will reconnect automatically.",
      customDomains: "Custom Domains",
      bypassDomains: "Bypass Domains",
      bypassDomainsDesc: "Domains that connect directly (bypass proxy)",
      proxyDomains: "Proxy Domains",
      proxyDomainsDesc: "Domains that force proxy connection",
      ...
      removeDomain: "Remove",
      domainsHint: "Supports wildcards: *.example.com or .example.com",
      lanBypass: "LAN Bypass",
      bypassLan: "Bypass LAN",
      bypassLanDesc: "Allow direct access to local network devices",
      lanRanges: "LAN IP Ranges",
    },
    login: {
      title: "Login",
      username: "Username",
  ...
  zh: {
    ...
    routing: {
      ...
      customDomains: "自定义域名",
      bypassDomains: "直连域名",
      bypassDomainsDesc: "这些域名将直接连接（绕过代理）",
      proxyDomains: "代理域名",
      proxyDomainsDesc: "这些域名将强制使用代理",
      addDomain: "添加域名",
      domainPlaceholder: "例如 example.com 或 *.example.com",
      invalidDomain: "域名格式无效",
      duplicateDomain: "域名已存在",
      removeDomain: "删除",
      domainsHint: "支持通配符：*.example.com 或 .example.com",
      lanBypass: "局域网绕过",
      bypassLan: "绕过局域网",
      bypassLanDesc: "允许直接访问本地网络设备",
      lanRanges: "局域网 IP 范围",
    },
    login: {
      title: "登录",
